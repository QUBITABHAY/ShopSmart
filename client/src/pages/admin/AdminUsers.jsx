  ...
  if (currentUser?.role !== 'MASTER_ADMIN') {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center px-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900 font-heading mb-2">Access Denied</h1>
        <p className="text-gray-500 max-w-md mx-auto mb-8 text-lg">
          You do not have the required permissions to access User Management. This section is restricted to Master Administrators only.
        </p>
        <button 
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Manage customer accounts and administrative privileges.</p>
        </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className={cn(
                          ...
                          user.role === 'MASTER_ADMIN' ? "bg-amber-100 text-amber-700 border-amber-200" :
